...
export const InputForm = ({ name, type = 'text', value = '', isSecondary = false, isReadOnly = false, props, label, placeholder, className, error = '' }: InputFormProps) => {
  return (
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      <Field {...props} type={type} id={name} readOnly={isReadOnly} disabled={isReadOnly} value={value} placeholder={placeholder} className={`
