  ...
  return (
    <>
      ...
      <div className="w-screen h-screen min-h-fit max-w-screen lg:overflow-hidden bg-background-main" aria-labelledby="header_PageTitle">
        ...
        <main className="px-4 md:px-12 lg:px-16 pt-24 h-fit lg:h-full w-full min-w-full lg:gap-12 lg:grid grid-cols-[2fr_minmax(340px,1fr)]">
          <div className="lg:col-start-1 lg:col-end-2 flex flex-col gap-7">
